...
############################################ Setup YOLO v3 ######################################################
lbl_file        = 'C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/yolov3.txt'
classes         = open(lbl_file).read().strip().split("\n")

yoloconfig      = 'C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/proctoring_models/yolov3.cfg'
yoloweights     = 'C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/proctoring_models/yolov3.weights'
