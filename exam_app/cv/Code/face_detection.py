...
def get_face_detector(modelFile=None,
    ...
    if quantized:
        if modelFile == None:
            modelFile = "C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/opencv_face_detector_uint8.pb"
        if configFile == None:
            configFile = "C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/opencv_face_detector.pbtxt"
        model = cv2.dnn.readNetFromTensorflow(modelFile, configFile)
        
    else:
        if modelFile == None:
            modelFile = "C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/res10_300x300_ssd_iter_140000.caffemodel"
        if configFile == None:
            configFile = "C:/Users/tilak/Desktop/hackathon/exam_project/exam_app/cv/Code/models/deploy.prototxt"
